...
class BaseConfig:
    """
    model & trainer base configuration
    """
    ...
    def from_args(self, args) -> "BaseConfig":
        """
    ...
    def from_config(self, config) -> "BaseConfig":
        """
    ...
    def save(self, file_dir: str, file_name: Optional[str] = 'config') -> "BaseConfig":
        """
    ...
    def load(self, file_dir: str, file_name: Optional[str] = 'config') -> "BaseConfig":
        """
