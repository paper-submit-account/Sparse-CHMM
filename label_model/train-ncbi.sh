...
TRAIN_PATH="../data_constr/NCBI-Disease/train.json"
VALID_PATH="../data_constr/NCBI-Disease/valid.json"
TEST_PATH="../data_constr/NCBI-Disease/test.json"
...
OUTPUT_DIR="./output/reg-NCBI/LB-wMV-${SEED}-${CONC_BASE}-${CONC_MAX}-${DIAG_EXP_T1}-${DIAG_EXP_T2}-${NONDIAG_EXP}-${NONDIAG_SPLIT_RATIO}-${NONDIAG_SPLIT_DECAY}/"
